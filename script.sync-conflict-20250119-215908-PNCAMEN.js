...
const helmetVSSource = `#version 300 es
	precision highp float;
...
const helmetFSSource = `#version 300 es
    precision mediump float;
...
//const helmetProgram = glance.createProgram(gl, "helmet-shader", helmetVSSource, helmetFSSource);
